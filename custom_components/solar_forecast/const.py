...
MIN_CORRECTION_SAMPLES = 5  # per-slot min before using its own factor vs overall mean
# Total samples required before ANY correction is applied.
# Below this, all factors stay 1.0 so refined == raw until the model is warm.
# 96 ≈ one full daytime day worth of valid 15-min recordings.
MIN_TOTAL_SAMPLES_FOR_CORRECTION = 96
